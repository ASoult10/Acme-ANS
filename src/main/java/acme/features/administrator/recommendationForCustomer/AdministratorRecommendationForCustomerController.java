...
@GuiController
public class AdministratorRecommendationForCustomerController {

	// Internal state ---------------------------------------------------------

	@Autowired
	private AdministratorRecommendationForCustomerCreateService createService;

	// Constructors -----------------------------------------------------------


	@GetMapping("/administrator/recommendation-for-customer/populate")
	public ModelAndView populateInitial() {
		...
		try {
			this.createService.loadRecommendationAPI();
