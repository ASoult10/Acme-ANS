...
public interface CustomerCustomerDashboardRepository extends AbstractRepository {
	...
	//	@Query("")
	//	List<String> lastFiveDestinations(Integer customerId);
	//
	//	@Query("")
	//	Money spentMoney(Integer customerId);
	//
	//	@Query("")
	//	Integereger economyBookings(Integer customerId);
	//
	//	@Query("")
	//	Integereger businessBookings(Integer customerId);
	//
	//	@Query("")
	...
	//
	//	@Query("")
	//	Integereger bookingTotalPassengers(Integer customerId);
	//
	//	@Query("")
	//	Double bookingAveragePassengers(Integer customerId);
	//
	//	@Query("")
	//	Integereger bookingMinimumPassengers(Integer customerId);
	//
	//	@Query("")
	//	Integereger bookingMaximumPassengers(Integer customerId);
	//
	//	@Query("")
